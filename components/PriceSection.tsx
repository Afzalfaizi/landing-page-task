...
export default function PriceSection() {
  return (
    <div className=" flex flex-col justify-center items-center">
      <div
        className=" text-4xl text-center md:text-6xl font-bold bg-gradient-to-r from-black to-gray-500
        text-transparent bg-clip-text md:pb-10"
      >
        Pricing
        <div className=" text-2xl text-center md:text-4xl font-bold mt-6 md:pb-10">
        ...
        {features.map((feature, index) => (
          <div key={index} className="p-4">
            <div className=" grid justify-center items-center gap-4 border rounded-xl p-4 w-96 h-96">
              ...
              <button className=" bg-blue-500 text-white p-4 rounded-xl items-center justify-center ">
                Get Started
              </button>
            </div>
          </div>
